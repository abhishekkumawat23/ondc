  ...
  _createClass(FeedbackCategoriesBody, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('feedback_categories')) obj.feedbackCategories = _ApiClient.ApiClient.convertToType(data['feedback_categories'], [_RatingCategory.RatingCategory]);
      }
      return obj;
    }
  }]);

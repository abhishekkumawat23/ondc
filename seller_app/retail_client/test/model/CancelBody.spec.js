...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CancelBody', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.CancelBody();
      });

      it('should create an instance of CancelBody', function() {
        // TODO: update the code to test CancelBody
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.CancelBody);
      });

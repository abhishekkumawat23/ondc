...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RatingBody', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.RatingBody();
      });

      it('should create an instance of RatingBody', function() {
        // TODO: update the code to test RatingBody
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.RatingBody);
      });

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Order', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.Order();
      });

      it('should create an instance of Order', function() {
        // TODO: update the code to test Order
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.Order);
      });
      ...
      it('should have the property ondcorglinkedOrders (base name: "@ondc/org/linked_orders")', function() {
        // TODO: update the code to test the property ondcorglinkedOrders
        expect(instance).to.have.property('ondcorglinkedOrders');
        // expect(instance.ondcorglinkedOrders).to.be(expectedValueLiteral);
      });

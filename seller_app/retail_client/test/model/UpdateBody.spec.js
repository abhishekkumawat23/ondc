...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateBody', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.UpdateBody();
      });

      it('should create an instance of UpdateBody', function() {
        // TODO: update the code to test UpdateBody
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.UpdateBody);
      });

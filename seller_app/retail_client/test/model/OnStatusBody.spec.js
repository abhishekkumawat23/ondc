...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OnStatusBody', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.OnStatusBody();
      });

      it('should create an instance of OnStatusBody', function() {
        // TODO: update the code to test OnStatusBody
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.OnStatusBody);
      });

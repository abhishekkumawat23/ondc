...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OnSelectMessageOrder', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.OnSelectMessageOrder();
      });

      it('should create an instance of OnSelectMessageOrder', function() {
        // TODO: update the code to test OnSelectMessageOrder
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.OnSelectMessageOrder);
      });

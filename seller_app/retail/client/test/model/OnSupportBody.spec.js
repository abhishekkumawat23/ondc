...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OnSupportBody', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.OnSupportBody();
      });

      it('should create an instance of OnSupportBody', function() {
        // TODO: update the code to test OnSupportBody
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.OnSupportBody);
      });

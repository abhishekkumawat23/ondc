...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OnRatingBody', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.OnRatingBody();
      });

      it('should create an instance of OnRatingBody', function() {
        // TODO: update the code to test OnRatingBody
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.OnRatingBody);
      });

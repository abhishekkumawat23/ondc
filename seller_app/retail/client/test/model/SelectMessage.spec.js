...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SelectMessage', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.SelectMessage();
      });

      it('should create an instance of SelectMessage', function() {
        // TODO: update the code to test SelectMessage
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.SelectMessage);
      });

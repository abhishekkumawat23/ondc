...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OnInitBody', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.OnInitBody();
      });

      it('should create an instance of OnInitBody', function() {
        // TODO: update the code to test OnInitBody
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.OnInitBody);
      });

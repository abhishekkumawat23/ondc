...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FulfillmentStart', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.FulfillmentStart();
      });

      it('should create an instance of FulfillmentStart', function() {
        // TODO: update the code to test FulfillmentStart
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.FulfillmentStart);
      });

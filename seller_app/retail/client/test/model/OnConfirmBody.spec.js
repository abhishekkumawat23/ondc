...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OnConfirmBody', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.OnConfirmBody();
      });

      it('should create an instance of OnConfirmBody', function() {
        // TODO: update the code to test OnConfirmBody
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.OnConfirmBody);
      });

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OnSelectBody', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.OnSelectBody();
      });

      it('should create an instance of OnSelectBody', function() {
        // TODO: update the code to test OnSelectBody
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.OnSelectBody);
      });

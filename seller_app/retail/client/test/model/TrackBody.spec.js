...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TrackBody', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.TrackBody();
      });

      it('should create an instance of TrackBody', function() {
        // TODO: update the code to test TrackBody
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.TrackBody);
      });

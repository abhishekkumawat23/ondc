 ...
 * @version 1.0.13
 */
var CancelMessage = /*#__PURE__*/function () {
  /**
   ...
   */
  function CancelMessage(orderId) {
    _classCallCheck(this, CancelMessage);
   ...
   */
  _createClass(CancelMessage, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('cancellation_reason_id')) obj.cancellationReasonId = _Optionpropertiesid.Optionpropertiesid.constructFromObject(data['cancellation_reason_id']);

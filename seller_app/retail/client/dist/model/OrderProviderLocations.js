...
exports.OrderProviderLocations = void 0;
 ...
 * @version 1.0.13
 */
var OrderProviderLocations = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>OrderProviderLocations</code>.
   * @alias module:model/OrderProviderLocations
   * @class
   * @param id {module:model/LocationId} 
   */
  function OrderProviderLocations(id) {
    _classCallCheck(this, OrderProviderLocations);
    this.id = id;
  }
   ...
   */
  _createClass(OrderProviderLocations, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new OrderProviderLocations();
        if (data.hasOwnProperty('id')) obj.id = _LocationId.LocationId.constructFromObject(data['id']);
      }
      return obj;
    }
  }]);
  return OrderProviderLocations;
}();
/**
 * @member {module:model/LocationId} id
 */
exports.OrderProviderLocations = OrderProviderLocations;

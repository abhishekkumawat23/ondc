  ...
  _createClass(RatingCategoriesBody, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('rating_categories')) obj.ratingCategories = _ApiClient.ApiClient.convertToType(data['rating_categories'], [_RatingpropertiesratingCategory.RatingpropertiesratingCategory]);
      }
      return obj;
    }
  }]);

...
exports.GetRatingCategoriesBody = void 0;
 ...
 * @version 1.0.13
 */
var GetRatingCategoriesBody = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetRatingCategoriesBody</code>.
   * @alias module:model/GetRatingCategoriesBody
   * @class
   */
  function GetRatingCategoriesBody() {
    _classCallCheck(this, GetRatingCategoriesBody);
  }
   ...
   */
  _createClass(GetRatingCategoriesBody, null, [{
  ...
  return GetRatingCategoriesBody;
}();
/**
 * @member {module:model/Context} context
 */
exports.GetRatingCategoriesBody = GetRatingCategoriesBody;

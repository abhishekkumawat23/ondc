...
exports.OnInitBody = void 0;
var _ApiClient = require("../ApiClient");
var _Context = require("./Context");
var _Error = require("./Error");
var _OnInitMessage = require("./OnInitMessage");
 ...
 * @version 1.0.13
 */
var OnInitBody = /*#__PURE__*/function () {
  /**
   ...
   */
  function OnInitBody(context) {
    _classCallCheck(this, OnInitBody);
  ...
  _createClass(OnInitBody, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('message')) obj.message = _OnInitMessage.OnInitMessage.constructFromObject(data['message']);
 ...
 */
exports.OnInitBody = OnInitBody;
OnInitBody.prototype.context = undefined;

/**
 * @member {module:model/OnInitMessage} message
 */

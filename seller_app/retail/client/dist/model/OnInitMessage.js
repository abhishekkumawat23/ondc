...
exports.OnInitMessage = void 0;
var _ApiClient = require("../ApiClient");
var _OnInitMessageOrder = require("./OnInitMessageOrder");
 ...
 * @version 1.0.13
 */
var OnInitMessage = /*#__PURE__*/function () {
  /**
   ...
   */
  function OnInitMessage(order) {
    _classCallCheck(this, OnInitMessage);
    this.order = order;
  }
   ...
   */
  _createClass(OnInitMessage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new OnInitMessage();
        if (data.hasOwnProperty('order')) obj.order = _OnInitMessageOrder.OnInitMessageOrder.constructFromObject(data['order']);
      }
      return obj;
    }
  }]);
 ...
 */
exports.OnInitMessage = OnInitMessage;

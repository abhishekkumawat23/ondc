...
var context = new OndcProtocolApiForRetailGroceryFb.Context(contextExample.domain, contextExample.country, contextExample.city, contextExample.action, contextExample.core_version, contextExample.bap_id, contextExample.bap_uri, contextExample.transaction_id, contextExample.message_id, contextExample.timestamp);
var message = {
  "intent": {
    "descriptor": {
      "name": "string",
    ...
    "provider": {
      ...
      "time": {
        ...
        "schedule": {
          "frequency": "string",
          "holidays": ["2023-06-10T15:39:53.664Z"],
          "times": ["2023-06-10T15:39:53.664Z"]
        }
      },
      "categories": [{
        "id": "Grocery",
        ...
        "start": {
          "location": {
            ...
            "time": {
              ...
              "schedule": {
                "frequency": "string",
                "holidays": ["2023-06-10T15:39:53.666Z"],
                "times": ["2023-06-10T15:39:53.666Z"]
              }
            }
          },
          "time": {
        ...
        "end": {
          "location": {
            ...
            "time": {
              ...
              "schedule": {
                "frequency": "string",
                "holidays": ["2023-06-10T15:39:53.668Z"],
                "times": ["2023-06-10T15:39:53.668Z"]
              }
            }
          },
          "time": {
      ...
      "locations": [{
        ...
        "time": {
          ...
          "schedule": {
            "frequency": "string",
            "holidays": ["2023-06-10T15:39:53.670Z"],
            "times": ["2023-06-10T15:39:53.670Z"]
          }
        },
        "rateable": true
      }],
      ...
      "start": {
        "location": {
          ...
          "time": {
            ...
            "schedule": {
              "frequency": "string",
              "holidays": ["2023-06-10T15:39:53.673Z"],
              "times": ["2023-06-10T15:39:53.673Z"]
            }
          }
        },
        "time": {
      ...
      "end": {
        "location": {
          ...
          "time": {
            ...
            "schedule": {
              "frequency": "string",
              "holidays": ["2023-06-10T15:39:53.681Z"],
              "times": ["2023-06-10T15:39:53.681Z"]
            }
          }
        },
        "time": {
    ...
    "payment": {
      ...
      "time": {
        ...
        "schedule": {
          "frequency": "string",
          "holidays": ["2023-06-10T15:39:53.682Z"],
          "times": ["2023-06-10T15:39:53.682Z"]
        }
      },
      "collected_by": "BAP"
    },
    ...
    "item": {
      ...
      "time": {
        ...
        "schedule": {
          "frequency": "string",
          "holidays": ["2023-06-10T15:39:53.683Z"],
          "times": ["2023-06-10T15:39:53.683Z"]
        }
      },
      "rateable": true,
      "matched": true,
...
var opts = {
  'body': new OndcProtocolApiForRetailGroceryFb.SearchBody(context, message)
};

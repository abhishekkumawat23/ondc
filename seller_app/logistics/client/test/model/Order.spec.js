...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Order', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForLogistics.Order();
      });

      it('should create an instance of Order', function() {
        // TODO: update the code to test Order
        expect(instance).to.be.a(OndcProtocolApiForLogistics.Order);
      });
      ...
      it('should have the property ondcorgcreatedBy (base name: "@ondc/org/created_by")', function() {
        // TODO: update the code to test the property ondcorgcreatedBy
        expect(instance).to.have.property('ondcorgcreatedBy');
        // expect(instance.ondcorgcreatedBy).to.be(expectedValueLiteral);
      });

      it('should have the property ondcorgcancellation (base name: "@ondc/org/cancellation")', function() {
        // TODO: update the code to test the property ondcorgcancellation
        expect(instance).to.have.property('ondcorgcancellation');
        // expect(instance.ondcorgcancellation).to.be(expectedValueLiteral);
      });

      it('should have the property ondcorglinkedOrder (base name: "@ondc/org/linked_order")', function() {
        // TODO: update the code to test the property ondcorglinkedOrder
        expect(instance).to.have.property('ondcorglinkedOrder');
        // expect(instance.ondcorglinkedOrder).to.be(expectedValueLiteral);
      });

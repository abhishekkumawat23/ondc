...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Fulfillment', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForLogistics.Fulfillment();
      });

      it('should create an instance of Fulfillment', function() {
        // TODO: update the code to test Fulfillment
        expect(instance).to.be.a(OndcProtocolApiForLogistics.Fulfillment);
      });
      ...
      it('should have the property ondcorgawbNo (base name: "@ondc/org/awb_no")', function() {
        // TODO: update the code to test the property ondcorgawbNo
        expect(instance).to.have.property('ondcorgawbNo');
        // expect(instance.ondcorgawbNo).to.be(expectedValueLiteral);
      });

      it('should have the property ondcorgewaybillno (base name: "@ondc/org/ewaybillno")', function() {
        // TODO: update the code to test the property ondcorgewaybillno
        expect(instance).to.have.property('ondcorgewaybillno');
        // expect(instance.ondcorgewaybillno).to.be(expectedValueLiteral);
      });

      it('should have the property ondcorgebnexpirydate (base name: "@ondc/org/ebnexpirydate")', function() {
        // TODO: update the code to test the property ondcorgebnexpirydate
        expect(instance).to.have.property('ondcorgebnexpirydate');
        // expect(instance.ondcorgebnexpirydate).to.be(expectedValueLiteral);
      });

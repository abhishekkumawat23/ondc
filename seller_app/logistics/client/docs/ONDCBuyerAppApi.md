# OndcProtocolApiForLogistics.ONDCBuyerAppApi
...
let apiInstance = new OndcProtocolApiForLogistics.ONDCBuyerAppApi();
let opts = { 
  'body': new OndcProtocolApiForLogistics.OnCancelBody() // OnCancelBody | Seller provides response to cancellation request
};
...
let apiInstance = new OndcProtocolApiForLogistics.ONDCBuyerAppApi();
let opts = { 
  'body': new OndcProtocolApiForLogistics.OnConfirmBody() // OnConfirmBody | Seller confirms order
};
...
let apiInstance = new OndcProtocolApiForLogistics.ONDCBuyerAppApi();
let opts = { 
  'body': new OndcProtocolApiForLogistics.OnInitBody() // OnInitBody | Seller provides terms and conditions for an order
};
...
let apiInstance = new OndcProtocolApiForLogistics.ONDCBuyerAppApi();
let opts = { 
  'body': new OndcProtocolApiForLogistics.OnRatingBody() // OnRatingBody | Seller provides response to rating provided by buyer
};
...
let apiInstance = new OndcProtocolApiForLogistics.ONDCBuyerAppApi();
let opts = { 
  'body': new OndcProtocolApiForLogistics.OnSearchBody() // OnSearchBody | Sellers provide their catalog in response to buyer search
};
...
let apiInstance = new OndcProtocolApiForLogistics.ONDCBuyerAppApi();
let opts = { 
  'body': new OndcProtocolApiForLogistics.OnSelectBody() // OnSelectBody | Seller provides quote for selected items
};
...
let apiInstance = new OndcProtocolApiForLogistics.ONDCBuyerAppApi();
let opts = { 
  'body': new OndcProtocolApiForLogistics.OnStatusBody() // OnStatusBody | Seller provides status information for order
};
...
let apiInstance = new OndcProtocolApiForLogistics.ONDCBuyerAppApi();
let opts = { 
  'body': new OndcProtocolApiForLogistics.OnSupportBody() // OnSupportBody | Seller provides Contact Support details
};
...
let apiInstance = new OndcProtocolApiForLogistics.ONDCBuyerAppApi();
let opts = { 
  'body': new OndcProtocolApiForLogistics.OnTrackBody() // OnTrackBody | Seller provides tracking details for an order
};
...
let apiInstance = new OndcProtocolApiForLogistics.ONDCBuyerAppApi();
let opts = { 
  'body': new OndcProtocolApiForLogistics.OnUpdateBody() // OnUpdateBody | Seller provides response to order update
};

# OndcProtocolApiForLogistics.BuyerAppMetaAPIsApi
...
let apiInstance = new OndcProtocolApiForLogistics.BuyerAppMetaAPIsApi();
let opts = { 
...
let apiInstance = new OndcProtocolApiForLogistics.BuyerAppMetaAPIsApi();
let opts = { 
  'body': new OndcProtocolApiForLogistics.FeedbackCategoriesBody() // FeedbackCategoriesBody | Array of categories for which feedback can be given by the Buyer App
};
...
let apiInstance = new OndcProtocolApiForLogistics.BuyerAppMetaAPIsApi();
let opts = { 
  'body': new OndcProtocolApiForLogistics.FeedbackFormBody() // FeedbackFormBody | Feedback form sent by the Buyer App
};
...
let apiInstance = new OndcProtocolApiForLogistics.BuyerAppMetaAPIsApi();
let opts = { 
  'body': new OndcProtocolApiForLogistics.RatingCategoriesBody() // RatingCategoriesBody | Array of categories which can be rated
};
...
let apiInstance = new OndcProtocolApiForLogistics.BuyerAppMetaAPIsApi();
let opts = { 
  'body': new OndcProtocolApiForLogistics.ReturnReasonsBody() // ReturnReasonsBody | List of return reasons
};

...
var _Policypropertiesid = require("./Policypropertiesid");
  ...
  _createClass(Policy, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('parent_policy_id')) obj.parentPolicyId = _Policypropertiesid.Policypropertiesid.constructFromObject(data['parent_policy_id']);

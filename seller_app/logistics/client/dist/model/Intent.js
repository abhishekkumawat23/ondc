...
var _IntentOndcorgpayloadDetails = require("./IntentOndcorgpayloadDetails");
  ...
  _createClass(Intent, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('@ondc/org/payload_details')) obj.ondcorgpayloadDetails = _IntentOndcorgpayloadDetails.IntentOndcorgpayloadDetails.constructFromObject(data['@ondc/org/payload_details']);

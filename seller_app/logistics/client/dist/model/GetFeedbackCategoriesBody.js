...
exports.GetFeedbackCategoriesBody = void 0;
 ...
 * @version 1.0.9
 */
var GetFeedbackCategoriesBody = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetFeedbackCategoriesBody</code>.
   * @alias module:model/GetFeedbackCategoriesBody
   * @class
   */
  function GetFeedbackCategoriesBody() {
    _classCallCheck(this, GetFeedbackCategoriesBody);
  }
   ...
   */
  _createClass(GetFeedbackCategoriesBody, null, [{
  ...
  return GetFeedbackCategoriesBody;
}();
/**
 * @member {module:model/Context} context
 */
exports.GetFeedbackCategoriesBody = GetFeedbackCategoriesBody;

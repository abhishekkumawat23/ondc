...
var _OrderOndcorglinkedOrder = require("./OrderOndcorglinkedOrder");
  ...
  _createClass(Order, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('@ondc/org/created_by')) obj.ondcorgcreatedBy = _ApiClient.ApiClient.convertToType(data['@ondc/org/created_by'], 'String');
        ...
        if (data.hasOwnProperty('@ondc/org/linked_order')) obj.ondcorglinkedOrder = _OrderOndcorglinkedOrder.OrderOndcorglinkedOrder.constructFromObject(data['@ondc/org/linked_order']);
      }
      return obj;
    }
  }]);

...
import {IntentOndcorgpayloadDetails} from './model/IntentOndcorgpayloadDetails';
...
import {OrderOndcorglinkedOrder} from './model/OrderOndcorglinkedOrder';
import {OrderOndcorglinkedOrderItems} from './model/OrderOndcorglinkedOrderItems';
import {OrderOndcorglinkedOrderOrder} from './model/OrderOndcorglinkedOrderOrder';
import {OrderOndcorglinkedOrderProvider} from './model/OrderOndcorglinkedOrderProvider';
...
import {PaymentOndcorgcodsettlementDetails} from './model/PaymentOndcorgcodsettlementDetails';
...
/**
* ONDC_Protocol_Core_API_specification__This_is_an_adaptation_of_Beckn_Core_version_0_9_3.<br>
* The <code>index</code> module provides access to constructors for all the classes which comprise the public API.
* <p>
* An AMD (recommended!) or CommonJS application will generally do something equivalent to the following:
* <pre>
* var OndcProtocolApiForLogistics = require('index'); // See note below*.
* var xxxSvc = new OndcProtocolApiForLogistics.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new OndcProtocolApiForLogistics.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new OndcProtocolApiForLogistics.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new OndcProtocolApiForLogistics.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
...
export {
    ...
    /**
     * The IntentOndcorgpayloadDetails model constructor.
     * @property {module:model/IntentOndcorgpayloadDetails}
     */
    ...
    /**
     * The OrderOndcorglinkedOrder model constructor.
     * @property {module:model/OrderOndcorglinkedOrder}
     */
    OrderOndcorglinkedOrder,

    /**
     * The OrderOndcorglinkedOrderItems model constructor.
     * @property {module:model/OrderOndcorglinkedOrderItems}
     */
    OrderOndcorglinkedOrderItems,

    /**
     * The OrderOndcorglinkedOrderOrder model constructor.
     * @property {module:model/OrderOndcorglinkedOrderOrder}
     */
    OrderOndcorglinkedOrderOrder,

    /**
     * The OrderOndcorglinkedOrderProvider model constructor.
     * @property {module:model/OrderOndcorglinkedOrderProvider}
     */
    OrderOndcorglinkedOrderProvider,
    ...
    /**
     * The PaymentOndcorgcodsettlementDetails model constructor.
     * @property {module:model/PaymentOndcorgcodsettlementDetails}
     */
    PaymentOndcorgcodsettlementDetails,

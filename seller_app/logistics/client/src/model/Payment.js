...
import {PaymentOndcorgcodsettlementDetails} from './PaymentOndcorgcodsettlementDetails';
...
export class Payment {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('@ondc/org/collection_amount'))
        obj.ondcorgcollectionAmount = ApiClient.convertToType(data['@ondc/org/collection_amount'], 'String');
      if (data.hasOwnProperty('@ondc/org/cod-settlement_window'))
        obj.ondcorgcodSettlementWindow = ApiClient.convertToType(data['@ondc/org/cod-settlement_window'], 'String');
      if (data.hasOwnProperty('@ondc/org/cod-settlement_window_status'))
        obj.ondcorgcodSettlementWindowStatus = ApiClient.convertToType(data['@ondc/org/cod-settlement_window_status'], 'String');
      if (data.hasOwnProperty('@ondc/org/cod-settlement_details'))
        obj.ondcorgcodSettlementDetails = ApiClient.convertToType(data['@ondc/org/cod-settlement_details'], [PaymentOndcorgcodsettlementDetails]);
    }
    return obj;
  }
}

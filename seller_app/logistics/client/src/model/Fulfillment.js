...
export class Fulfillment {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('@ondc/org/awb_no'))
        obj.ondcorgawbNo = ApiClient.convertToType(data['@ondc/org/awb_no'], 'String');
      if (data.hasOwnProperty('@ondc/org/ewaybillno'))
        obj.ondcorgewaybillno = ApiClient.convertToType(data['@ondc/org/ewaybillno'], 'String');
      if (data.hasOwnProperty('@ondc/org/ebnexpirydate'))
        obj.ondcorgebnexpirydate = ApiClient.convertToType(data['@ondc/org/ebnexpirydate'], 'Date');

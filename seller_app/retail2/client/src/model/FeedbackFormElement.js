...
import {FeedbackFormElementId} from './FeedbackFormElementId';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('id'))
        obj.id = FeedbackFormElementId.constructFromObject(data['id']);
      if (data.hasOwnProperty('parent_id'))
        obj.parentId = FeedbackFormElementId.constructFromObject(data['parent_id']);

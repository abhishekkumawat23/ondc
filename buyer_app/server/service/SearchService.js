...
function transformSearchBody(body){
return {
      "intent" : {
        "item": {
          "id": "item1",
          ...
          "@ondc/org/return_window": true,
          "@ondc/org/return_window": "P3DT12H",
          "@ondc/org/cancellable": true,
          "@ondc/org/time_to_ship": "PT12H",
          "@ondc/org/available_on_cod": true,
          "@ondc/org/contact_details_consumer_care": 'mobile : +91999999999',
          "@ondc/org/statutory_reqs_packaged_commodities": {
            "description": "mandatory for category_id \"Packaged Commodities\" - required attributes for all include the following - manufacturer_or_packer_name, manufacturer_or_packer_address, common_or_generic_name_of_commodity, net_quantity_or_measure_of_commodity_in_pkg, month_year_of_manufacture_packing_import; other attributes are required on case-by-case basis"
          },
          "@ondc/org/statutory_reqs_prepackaged_food": {
            "description": "mandatory for category_id \"Packaged food\" - required attributes include the following - nutritional_info, additives_info, net_quantity; other attributes are required on case-by-case basis"
          },
          "@ondc/org/mandatory_reqs_veggies_fruits":{
            "description": "mandatory for category_id \"Fruits and Vegetables\" required attributes include the following - net_quantity"
          },
          "descriptor" : {
              "name" : body.search_string
          }
        },
        "fulfillment": {
            "id": "fid1",
...
function searchbyproductPOST(searchBody, callback) {
  ...
  var opts = {
    'body': new OndcGateway.SearchBody(context, searchBody)
  };
  console.log('hello1')
...
exports.searchbyproduct = async function (body) {
  ...
  let searchBody = transformSearchBody(body);
  ...
  /*return new Promise(function (resolve, reject) {
   ...
   let data = await util.promisify(searchbyproductPOST)(searchBody);

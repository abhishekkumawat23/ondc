...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Address17', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Address17();
      });

      it('should create an instance of Address17', function() {
        // TODO: update the code to test Address17
        expect(instance).to.be.a(SandboxClientSdk.Address17);
      });

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Message3', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Message3();
      });

      it('should create an instance of Message3', function() {
        // TODO: update the code to test Message3
        expect(instance).to.be.a(SandboxClientSdk.Message3);
      });

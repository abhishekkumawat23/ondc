...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Provider1', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Provider1();
      });

      it('should create an instance of Provider1', function() {
        // TODO: update the code to test Provider1
        expect(instance).to.be.a(SandboxClientSdk.Provider1);
      });

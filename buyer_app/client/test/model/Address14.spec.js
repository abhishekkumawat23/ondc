...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Address14', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Address14();
      });

      it('should create an instance of Address14', function() {
        // TODO: update the code to test Address14
        expect(instance).to.be.a(SandboxClientSdk.Address14);
      });

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Oninit', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Oninit();
      });

      it('should create an instance of Oninit', function() {
        // TODO: update the code to test Oninit
        expect(instance).to.be.a(SandboxClientSdk.Oninit);
      });

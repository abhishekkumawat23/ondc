...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Onsupport', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Onsupport();
      });

      it('should create an instance of Onsupport', function() {
        // TODO: update the code to test Onsupport
        expect(instance).to.be.a(SandboxClientSdk.Onsupport);
      });

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Supportrequest', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Supportrequest();
      });

      it('should create an instance of Supportrequest', function() {
        // TODO: update the code to test Supportrequest
        expect(instance).to.be.a(SandboxClientSdk.Supportrequest);
      });

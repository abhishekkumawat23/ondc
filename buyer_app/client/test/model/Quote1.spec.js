...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Quote1', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Quote1();
      });

      it('should create an instance of Quote1', function() {
        // TODO: update the code to test Quote1
        expect(instance).to.be.a(SandboxClientSdk.Quote1);
      });

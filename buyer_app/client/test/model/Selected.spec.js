...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Selected', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Selected();
      });

      it('should create an instance of Selected', function() {
        // TODO: update the code to test Selected
        expect(instance).to.be.a(SandboxClientSdk.Selected);
      });

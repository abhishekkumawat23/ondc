...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Addbillingaddress', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Addbillingaddress();
      });

      it('should create an instance of Addbillingaddress', function() {
        // TODO: update the code to test Addbillingaddress
        expect(instance).to.be.a(SandboxClientSdk.Addbillingaddress);
      });

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProviderDetails2', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.ProviderDetails2();
      });

      it('should create an instance of ProviderDetails2', function() {
        // TODO: update the code to test ProviderDetails2
        expect(instance).to.be.a(SandboxClientSdk.ProviderDetails2);
      });

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Descriptor2', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Descriptor2();
      });

      it('should create an instance of Descriptor2', function() {
        // TODO: update the code to test Descriptor2
        expect(instance).to.be.a(SandboxClientSdk.Descriptor2);
      });

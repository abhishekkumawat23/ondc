...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Payment3', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Payment3();
      });

      it('should create an instance of Payment3', function() {
        // TODO: update the code to test Payment3
        expect(instance).to.be.a(SandboxClientSdk.Payment3);
      });
      ...
      it('should have the property tlMethod (base name: "tlMethod")', function() {

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Provider2', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Provider2();
      });

      it('should create an instance of Provider2', function() {
        // TODO: update the code to test Provider2
        expect(instance).to.be.a(SandboxClientSdk.Provider2);
      });

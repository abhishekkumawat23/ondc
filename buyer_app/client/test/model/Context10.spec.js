...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Context10', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Context10();
      });

      it('should create an instance of Context10', function() {
        // TODO: update the code to test Context10
        expect(instance).to.be.a(SandboxClientSdk.Context10);
      });

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Address21', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Address21();
      });

      it('should create an instance of Address21', function() {
        // TODO: update the code to test Address21
        expect(instance).to.be.a(SandboxClientSdk.Address21);
      });

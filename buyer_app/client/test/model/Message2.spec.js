...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Message2', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Message2();
      });

      it('should create an instance of Message2', function() {
        // TODO: update the code to test Message2
        expect(instance).to.be.a(SandboxClientSdk.Message2);
      });

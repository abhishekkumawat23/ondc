...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Ontrack', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Ontrack();
      });

      it('should create an instance of Ontrack', function() {
        // TODO: update the code to test Ontrack
        expect(instance).to.be.a(SandboxClientSdk.Ontrack);
      });

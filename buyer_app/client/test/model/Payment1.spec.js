...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Payment1', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Payment1();
      });

      it('should create an instance of Payment1', function() {
        // TODO: update the code to test Payment1
        expect(instance).to.be.a(SandboxClientSdk.Payment1);
      });

      it('should have the property paidAmount (base name: "paid_amount")', function() {
        // TODO: update the code to test the property paidAmount
        expect(instance).to.have.property('paidAmount');
        // expect(instance.paidAmount).to.be(expectedValueLiteral);
      });

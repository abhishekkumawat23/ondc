...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Message9', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Message9();
      });

      it('should create an instance of Message9', function() {
        // TODO: update the code to test Message9
        expect(instance).to.be.a(SandboxClientSdk.Message9);
      });

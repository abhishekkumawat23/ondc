...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Message15', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Message15();
      });

      it('should create an instance of Message15', function() {
        // TODO: update the code to test Message15
        expect(instance).to.be.a(SandboxClientSdk.Message15);
      });

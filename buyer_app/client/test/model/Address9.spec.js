...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Address9', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Address9();
      });

      it('should create an instance of Address9', function() {
        // TODO: update the code to test Address9
        expect(instance).to.be.a(SandboxClientSdk.Address9);
      });

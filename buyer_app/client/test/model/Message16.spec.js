...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Message16', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Message16();
      });

      it('should create an instance of Message16', function() {
        // TODO: update the code to test Message16
        expect(instance).to.be.a(SandboxClientSdk.Message16);
      });

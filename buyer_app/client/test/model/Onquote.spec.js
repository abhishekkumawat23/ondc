...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Onquote', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Onquote();
      });

      it('should create an instance of Onquote', function() {
        // TODO: update the code to test Onquote
        expect(instance).to.be.a(SandboxClientSdk.Onquote);
      });

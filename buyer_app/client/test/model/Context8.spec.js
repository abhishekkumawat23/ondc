...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Context8', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Context8();
      });

      it('should create an instance of Context8', function() {
        // TODO: update the code to test Context8
        expect(instance).to.be.a(SandboxClientSdk.Context8);
      });

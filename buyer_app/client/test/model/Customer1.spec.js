...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Customer1', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Customer1();
      });

      it('should create an instance of Customer1', function() {
        // TODO: update the code to test Customer1
        expect(instance).to.be.a(SandboxClientSdk.Customer1);
      });

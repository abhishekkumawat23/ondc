...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Address22', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Address22();
      });

      it('should create an instance of Address22', function() {
        // TODO: update the code to test Address22
        expect(instance).to.be.a(SandboxClientSdk.Address22);
      });

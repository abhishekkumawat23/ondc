...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Descriptor12', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Descriptor12();
      });

      it('should create an instance of Descriptor12', function() {
        // TODO: update the code to test Descriptor12
        expect(instance).to.be.a(SandboxClientSdk.Descriptor12);
      });

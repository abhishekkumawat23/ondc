...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Onconfirm', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Onconfirm();
      });

      it('should create an instance of Onconfirm', function() {
        // TODO: update the code to test Onconfirm
        expect(instance).to.be.a(SandboxClientSdk.Onconfirm);
      });

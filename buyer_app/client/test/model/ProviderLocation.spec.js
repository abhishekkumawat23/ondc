...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProviderLocation', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.ProviderLocation();
      });

      it('should create an instance of ProviderLocation', function() {
        // TODO: update the code to test ProviderLocation
        expect(instance).to.be.a(SandboxClientSdk.ProviderLocation);
      });

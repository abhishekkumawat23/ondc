...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Address16', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Address16();
      });

      it('should create an instance of Address16', function() {
        // TODO: update the code to test Address16
        expect(instance).to.be.a(SandboxClientSdk.Address16);
      });

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Confirmorder', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Confirmorder();
      });

      it('should create an instance of Confirmorder', function() {
        // TODO: update the code to test Confirmorder
        expect(instance).to.be.a(SandboxClientSdk.Confirmorder);
      });

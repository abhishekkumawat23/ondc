...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Criteria2', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Criteria2();
      });

      it('should create an instance of Criteria2', function() {
        // TODO: update the code to test Criteria2
        expect(instance).to.be.a(SandboxClientSdk.Criteria2);
      });

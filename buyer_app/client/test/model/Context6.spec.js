...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Context6', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Context6();
      });

      it('should create an instance of Context6', function() {
        // TODO: update the code to test Context6
        expect(instance).to.be.a(SandboxClientSdk.Context6);
      });

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Updatedeliveryaddress', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Updatedeliveryaddress();
      });

      it('should create an instance of Updatedeliveryaddress', function() {
        // TODO: update the code to test Updatedeliveryaddress
        expect(instance).to.be.a(SandboxClientSdk.Updatedeliveryaddress);
      });

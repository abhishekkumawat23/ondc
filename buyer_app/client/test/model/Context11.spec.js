...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Context11', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Context11();
      });

      it('should create an instance of Context11', function() {
        // TODO: update the code to test Context11
        expect(instance).to.be.a(SandboxClientSdk.Context11);
      });

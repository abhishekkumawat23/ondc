...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Initorder', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Initorder();
      });

      it('should create an instance of Initorder', function() {
        // TODO: update the code to test Initorder
        expect(instance).to.be.a(SandboxClientSdk.Initorder);
      });

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Payment2', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Payment2();
      });

      it('should create an instance of Payment2', function() {
        // TODO: update the code to test Payment2
        expect(instance).to.be.a(SandboxClientSdk.Payment2);
      });

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Updatebillingaddress', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Updatebillingaddress();
      });

      it('should create an instance of Updatebillingaddress', function() {
        // TODO: update the code to test Updatebillingaddress
        expect(instance).to.be.a(SandboxClientSdk.Updatebillingaddress);
      });

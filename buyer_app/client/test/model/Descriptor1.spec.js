...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Descriptor1', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Descriptor1();
      });

      it('should create an instance of Descriptor1', function() {
        // TODO: update the code to test Descriptor1
        expect(instance).to.be.a(SandboxClientSdk.Descriptor1);
      });

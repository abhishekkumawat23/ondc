...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Descriptor9', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Descriptor9();
      });

      it('should create an instance of Descriptor9', function() {
        // TODO: update the code to test Descriptor9
        expect(instance).to.be.a(SandboxClientSdk.Descriptor9);
      });

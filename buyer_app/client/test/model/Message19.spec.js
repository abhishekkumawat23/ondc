...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Message19', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Message19();
      });

      it('should create an instance of Message19', function() {
        // TODO: update the code to test Message19
        expect(instance).to.be.a(SandboxClientSdk.Message19);
      });

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LocationDetails1', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.LocationDetails1();
      });

      it('should create an instance of LocationDetails1', function() {
        // TODO: update the code to test LocationDetails1
        expect(instance).to.be.a(SandboxClientSdk.LocationDetails1);
      });

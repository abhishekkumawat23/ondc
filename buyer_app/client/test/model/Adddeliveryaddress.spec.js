...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Adddeliveryaddress', function() {
      beforeEach(function() {
        instance = new SandboxClientSdk.Adddeliveryaddress();
      });

      it('should create an instance of Adddeliveryaddress', function() {
        // TODO: update the code to test Adddeliveryaddress
        expect(instance).to.be.a(SandboxClientSdk.Adddeliveryaddress);
      });

...
exports.Searchbyproviderrequest = void 0;
 ...
 * @version 1.0
 */
var Searchbyproviderrequest = /*#__PURE__*/function () {
  /**
   ...
   */
  function Searchbyproviderrequest(context, message) {
    _classCallCheck(this, Searchbyproviderrequest);
   ...
   */
  _createClass(Searchbyproviderrequest, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('message')) obj.message = _Message.Message3.constructFromObject(data['message']);
      }
      return obj;
    }
  }]);
  return Searchbyproviderrequest;
}();
/**
 * @member {Object} context
 */
exports.Searchbyproviderrequest = Searchbyproviderrequest;

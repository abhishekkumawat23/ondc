 ...
 * @version 1.0
 */
var OneOfCatalogId = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>OneOfCatalogId</code>.
   * @alias module:model/OneOfCatalogId
   * @class
   */
  function OneOfCatalogId() {
    _classCallCheck(this, OneOfCatalogId);
  }
   ...
   */
  _createClass(OneOfCatalogId, null, [{
  ...
  return OneOfCatalogId;
}();
exports.OneOfCatalogId = OneOfCatalogId;
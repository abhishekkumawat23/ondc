 ...
 * @version 1.0
 */
var Payment1 = /*#__PURE__*/function () {
  /**
   ...
   */
  function Payment1(paidAmount, type, transactionId) {
    _classCallCheck(this, Payment1);
   ...
   */
  _createClass(Payment1, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new Payment1();
        if (data.hasOwnProperty('paid_amount')) obj.paidAmount = _ApiClient.ApiClient.convertToType(data['paid_amount'], 'Number');

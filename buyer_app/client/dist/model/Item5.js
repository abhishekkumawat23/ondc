...
var _Quantity = require("./Quantity5");
  ...
  _createClass(Item5, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('quantity')) obj.quantity = _Quantity.Quantity5.constructFromObject(data['quantity']);
      }
      return obj;
    }
  }]);

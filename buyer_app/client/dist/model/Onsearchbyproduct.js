...
exports.Onsearchbyproduct = void 0;
var _ApiClient = require("../ApiClient");
var _Context = require("./Context");
var _Message = require("./Message5");
 ...
 * @version 1.0
 */
var Onsearchbyproduct = /*#__PURE__*/function () {
  /**
   ...
   */
  function Onsearchbyproduct(context, message) {
    _classCallCheck(this, Onsearchbyproduct);
   ...
   */
  _createClass(Onsearchbyproduct, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('message')) obj.message = _Message.Message5.constructFromObject(data['message']);
      }
      return obj;
    }
  }]);
  return Onsearchbyproduct;
}();
/**
 * @member {module:model/Context} context
 */
exports.Onsearchbyproduct = Onsearchbyproduct;

...
exports.LocationDetails1 = void 0;
var _ApiClient = require("../ApiClient");
var _Address = require("./Address1");
 ...
 * @version 1.0
 */
var LocationDetails1 = /*#__PURE__*/function () {
  /**
   ...
   */
  function LocationDetails1(id, gps, address, city, country) {
    _classCallCheck(this, LocationDetails1);
    this.id = id;
    this.gps = gps;
   ...
   */
  _createClass(LocationDetails1, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('address')) obj.address = _Address.Address1.constructFromObject(data['address']);
 ...
 * @member {String} id
 */
exports.LocationDetails1 = LocationDetails1;

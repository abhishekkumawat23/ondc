...
exports.Updatedeliveryaddressrequest = void 0;
var _ApiClient = require("../ApiClient");
var _Address = require("./Address14");
var _Descriptor = require("./Descriptor11");
 ...
 * @version 1.0
 */
var Updatedeliveryaddressrequest = /*#__PURE__*/function () {
  /**
   ...
   */
  function Updatedeliveryaddressrequest(descriptor, address) {
    _classCallCheck(this, Updatedeliveryaddressrequest);
   ...
   */
  _createClass(Updatedeliveryaddressrequest, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new Updatedeliveryaddressrequest();
        if (data.hasOwnProperty('descriptor')) obj.descriptor = _Descriptor.Descriptor11.constructFromObject(data['descriptor']);
        if (data.hasOwnProperty('address')) obj.address = _Address.Address14.constructFromObject(data['address']);
      }
      return obj;
    }
  }]);
  return Updatedeliveryaddressrequest;
}();
/**
 * @member {module:model/Descriptor11} descriptor
 */
exports.Updatedeliveryaddressrequest = Updatedeliveryaddressrequest;

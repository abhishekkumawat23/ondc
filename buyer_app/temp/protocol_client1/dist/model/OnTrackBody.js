...
exports.OnTrackBody = void 0;
var _ApiClient = require("../ApiClient");
var _Context = require("./Context");
var _Error = require("./Error");
var _OnTrackMessage = require("./OnTrackMessage");
 ...
 * @version 1.0.13
 */
var OnTrackBody = /*#__PURE__*/function () {
  /**
   ...
   */
  function OnTrackBody(context) {
    _classCallCheck(this, OnTrackBody);
  ...
  _createClass(OnTrackBody, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('message')) obj.message = _OnTrackMessage.OnTrackMessage.constructFromObject(data['message']);
 ...
 */
exports.OnTrackBody = OnTrackBody;

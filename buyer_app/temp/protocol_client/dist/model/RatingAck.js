 ...
 * @version 1.0.29
 */
var RatingAck = /*#__PURE__*/function () {
  /**
   ...
   */
  function RatingAck() {
    _classCallCheck(this, RatingAck);
  }
   ...
   */
  _createClass(RatingAck, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new RatingAck();
        if (data.hasOwnProperty('feedback_ack')) obj.feedbackAck = _ApiClient.ApiClient.convertToType(data['feedback_ack'], 'Boolean');
        if (data.hasOwnProperty('rating_ack')) obj.ratingAck = _ApiClient.ApiClient.convertToType(data['rating_ack'], 'Boolean');
      }
      return obj;
    }
  }]);

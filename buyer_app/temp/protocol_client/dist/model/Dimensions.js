  ...
  _createClass(Dimensions, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('length')) obj.length = _Scalar.Scalar.constructFromObject(data['length']);
        if (data.hasOwnProperty('breadth')) obj.breadth = _Scalar.Scalar.constructFromObject(data['breadth']);
        if (data.hasOwnProperty('height')) obj.height = _Scalar.Scalar.constructFromObject(data['height']);
      }
      return obj;
    }
  }]);

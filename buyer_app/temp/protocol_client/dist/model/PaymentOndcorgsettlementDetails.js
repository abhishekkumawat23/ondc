  ...
  _createClass(PaymentOndcorgsettlementDetails, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('settlement_amount')) obj.settlementAmount = _ApiClient.ApiClient.convertToType(data['settlement_amount'], 'Number');
        ...
        if (data.hasOwnProperty('beneficiary_name')) obj.beneficiaryName = _ApiClient.ApiClient.convertToType(data['beneficiary_name'], 'String');
 ...
 */
PaymentOndcorgsettlementDetails.prototype.beneficiaryName = undefined;

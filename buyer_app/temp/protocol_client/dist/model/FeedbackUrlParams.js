...
exports.FeedbackUrlParams = void 0;
 ...
 * @version 1.0.29
 */
var FeedbackUrlParams = /*#__PURE__*/function () {
  /**
   ...
   */
  function FeedbackUrlParams(feedbackId) {
    _classCallCheck(this, FeedbackUrlParams);
   ...
   */
  _createClass(FeedbackUrlParams, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new FeedbackUrlParams();
        if (data.hasOwnProperty('feedback_id')) obj.feedbackId = _ApiClient.ApiClient.convertToType(data['feedback_id'], 'String');
      }
      return obj;
    }
  }]);
 ...
 */
exports.FeedbackUrlParams = FeedbackUrlParams;

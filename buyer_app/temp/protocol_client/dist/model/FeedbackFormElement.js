...
var _FeedbackFormElementpropertiesid = require("./FeedbackFormElementpropertiesid");
  ...
  _createClass(FeedbackFormElement, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('parent_id')) obj.parentId = _FeedbackFormElementpropertiesid.FeedbackFormElementpropertiesid.constructFromObject(data['parent_id']);

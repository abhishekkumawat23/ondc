...
exports.ItemQuantityMaximum = void 0;
 ...
 * @version 1.0.29
 */
var ItemQuantityMaximum = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ItemQuantityMaximum</code>.
   * @alias module:model/ItemQuantityMaximum
   * @class
   */
  function ItemQuantityMaximum() {
    _classCallCheck(this, ItemQuantityMaximum);
  }
   ...
   */
  _createClass(ItemQuantityMaximum, null, [{
  ...
  return ItemQuantityMaximum;
}();
/**
 * @member {Number} count
 */
exports.ItemQuantityMaximum = ItemQuantityMaximum;

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OnCancelBody', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.OnCancelBody();
      });

      it('should create an instance of OnCancelBody', function() {
        // TODO: update the code to test OnCancelBody
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.OnCancelBody);
      });

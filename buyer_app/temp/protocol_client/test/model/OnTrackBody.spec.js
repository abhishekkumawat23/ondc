...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OnTrackBody', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.OnTrackBody();
      });

      it('should create an instance of OnTrackBody', function() {
        // TODO: update the code to test OnTrackBody
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.OnTrackBody);
      });

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PaymentOndcorgsettlementDetails', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.PaymentOndcorgsettlementDetails();
      });

      it('should create an instance of PaymentOndcorgsettlementDetails', function() {
        // TODO: update the code to test PaymentOndcorgsettlementDetails
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.PaymentOndcorgsettlementDetails);
      });
      ...
      it('should have the property settlementPhase (base name: "settlement_phase")', function() {
        // TODO: update the code to test the property settlementPhase
        expect(instance).to.have.property('settlementPhase');
        // expect(instance.settlementPhase).to.be(expectedValueLiteral);
      });

      it('should have the property settlementAmount (base name: "settlement_amount")', function() {
        // TODO: update the code to test the property settlementAmount
        expect(instance).to.have.property('settlementAmount');
        // expect(instance.settlementAmount).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property beneficiaryAddress (base name: "beneficiary_address")', function() {
        // TODO: update the code to test the property beneficiaryAddress
        expect(instance).to.have.property('beneficiaryAddress');
        // expect(instance.beneficiaryAddress).to.be(expectedValueLiteral);
      });

...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ConfirmBody', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.ConfirmBody();
      });

      it('should create an instance of ConfirmBody', function() {
        // TODO: update the code to test ConfirmBody
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.ConfirmBody);
      });

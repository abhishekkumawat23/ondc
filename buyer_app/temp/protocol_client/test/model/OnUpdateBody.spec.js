...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OnUpdateBody', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.OnUpdateBody();
      });

      it('should create an instance of OnUpdateBody', function() {
        // TODO: update the code to test OnUpdateBody
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.OnUpdateBody);
      });

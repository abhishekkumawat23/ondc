...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SupportBody', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.SupportBody();
      });

      it('should create an instance of SupportBody', function() {
        // TODO: update the code to test SupportBody
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.SupportBody);
      });

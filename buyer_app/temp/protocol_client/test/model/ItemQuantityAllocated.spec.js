...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ItemQuantityAllocated', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.ItemQuantityAllocated();
      });

      it('should create an instance of ItemQuantityAllocated', function() {
        // TODO: update the code to test ItemQuantityAllocated
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.ItemQuantityAllocated);
      });

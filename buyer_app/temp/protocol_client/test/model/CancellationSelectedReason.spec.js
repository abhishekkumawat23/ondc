...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CancellationSelectedReason', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.CancellationSelectedReason();
      });
      ...
      it('should create an instance of CancellationSelectedReason', function() {
        ...
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.CancellationSelectedReason);
      });

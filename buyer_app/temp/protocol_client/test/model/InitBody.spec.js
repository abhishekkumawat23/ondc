...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InitBody', function() {
      beforeEach(function() {
        instance = new OndcProtocolApiForRetailGroceryFb.InitBody();
      });

      it('should create an instance of InitBody', function() {
        // TODO: update the code to test InitBody
        expect(instance).to.be.a(OndcProtocolApiForRetailGroceryFb.InitBody);
      });

  ...
  _createClass(Context, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('core_version')) obj.core_version = _ApiClient.ApiClient.convertToType(data['core_version'], 'String');
        if (data.hasOwnProperty('bap_id')) obj.bap_id = _ApiClient.ApiClient.convertToType(data['bap_id'], 'String');
        if (data.hasOwnProperty('bap_uri')) obj.bap_uri = _ApiClient.ApiClient.convertToType(data['bap_uri'], 'String');
        if (data.hasOwnProperty('bpp_id')) obj.bpp_id = _ApiClient.ApiClient.convertToType(data['bpp_id'], 'String');
        if (data.hasOwnProperty('bpp_uri')) obj.bpp_uri = _ApiClient.ApiClient.convertToType(data['bpp_uri'], 'String');
        if (data.hasOwnProperty('transaction_id')) obj.transaction_id = _ApiClient.ApiClient.convertToType(data['transaction_id'], 'String');
        if (data.hasOwnProperty('message_id')) obj.message_id = _ApiClient.ApiClient.convertToType(data['message_id'], 'String');

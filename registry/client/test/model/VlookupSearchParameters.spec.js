...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VlookupSearchParameters', function() {
      beforeEach(function() {
        instance = new OndcRegistry_.VlookupSearchParameters();
      });

      it('should create an instance of VlookupSearchParameters', function() {
        // TODO: update the code to test VlookupSearchParameters
        expect(instance).to.be.a(OndcRegistry_.VlookupSearchParameters);
      });

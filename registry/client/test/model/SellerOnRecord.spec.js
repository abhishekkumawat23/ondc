...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SellerOnRecord', function() {
      beforeEach(function() {
        instance = new OndcRegistry_.SellerOnRecord();
      });

      it('should create an instance of SellerOnRecord', function() {
        // TODO: update the code to test SellerOnRecord
        expect(instance).to.be.a(OndcRegistry_.SellerOnRecord);
      });

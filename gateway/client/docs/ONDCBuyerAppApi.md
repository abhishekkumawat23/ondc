# OndcProtocolCoreApi.ONDCBuyerAppApi
...
let apiInstance = new OndcProtocolCoreApi.ONDCBuyerAppApi();
let opts = { 
  'body': new OndcProtocolCoreApi.OnCancelBody() // OnCancelBody | Seller provides response to cancellation request
};
...
let apiInstance = new OndcProtocolCoreApi.ONDCBuyerAppApi();
let opts = { 
  'body': new OndcProtocolCoreApi.OnConfirmBody() // OnConfirmBody | Seller confirms order
};
...
let apiInstance = new OndcProtocolCoreApi.ONDCBuyerAppApi();
let opts = { 
  'body': new OndcProtocolCoreApi.OnInitBody() // OnInitBody | Seller provides terms and conditions for an order
};
...
let apiInstance = new OndcProtocolCoreApi.ONDCBuyerAppApi();
let opts = { 
  'body': new OndcProtocolCoreApi.OnRatingBody() // OnRatingBody | Seller provides response to rating provided by buyer
};
...
let apiInstance = new OndcProtocolCoreApi.ONDCBuyerAppApi();
let opts = { 
  'body': new OndcProtocolCoreApi.OnSelectBody() // OnSelectBody | Seller provides quote for selected items
};
...
let apiInstance = new OndcProtocolCoreApi.ONDCBuyerAppApi();
let opts = { 
  'body': new OndcProtocolCoreApi.OnStatusBody() // OnStatusBody | Seller provides status information for order
};
...
let apiInstance = new OndcProtocolCoreApi.ONDCBuyerAppApi();
let opts = { 
  'body': new OndcProtocolCoreApi.OnSupportBody() // OnSupportBody | Seller provides Contact Support details
};
...
let apiInstance = new OndcProtocolCoreApi.ONDCBuyerAppApi();
let opts = { 
  'body': new OndcProtocolCoreApi.OnTrackBody() // OnTrackBody | Seller provides tracking details for an order
};
...
let apiInstance = new OndcProtocolCoreApi.ONDCBuyerAppApi();
let opts = { 
  'body': new OndcProtocolCoreApi.OnUpdateBody() // OnUpdateBody | Seller provides response to order update
};

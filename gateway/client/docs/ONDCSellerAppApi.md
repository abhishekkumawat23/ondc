# OndcProtocolCoreApi.ONDCSellerAppApi
...
let apiInstance = new OndcProtocolCoreApi.ONDCSellerAppApi();
let opts = { 
  'body': new OndcProtocolCoreApi.CancelBody() // CancelBody | Buyer cancels an order
};
...
let apiInstance = new OndcProtocolCoreApi.ONDCSellerAppApi();
let opts = { 
  'body': new OndcProtocolCoreApi.ConfirmBody() // ConfirmBody | Buyer confirms an order
};
...
let apiInstance = new OndcProtocolCoreApi.ONDCSellerAppApi();
let opts = { 
  'body': new OndcProtocolCoreApi.InitBody() // InitBody | Buyer initializes order checkout
};
...
let apiInstance = new OndcProtocolCoreApi.ONDCSellerAppApi();
let opts = { 
  'body': new OndcProtocolCoreApi.RatingBody() // RatingBody | Buyer rates for one or more rating categories
};
...
let apiInstance = new OndcProtocolCoreApi.ONDCSellerAppApi();
let opts = { 
  'body': new OndcProtocolCoreApi.SelectBody() // SelectBody | Buyer selects one or more catalog items
};
...
let apiInstance = new OndcProtocolCoreApi.ONDCSellerAppApi();
let opts = { 
  'body': new OndcProtocolCoreApi.StatusBody() // StatusBody | Buyer checks for status of order
};
...
let apiInstance = new OndcProtocolCoreApi.ONDCSellerAppApi();
let opts = { 
  'body': new OndcProtocolCoreApi.SupportBody() // SupportBody | Buyer searches for Support Contact details
};
...
let apiInstance = new OndcProtocolCoreApi.ONDCSellerAppApi();
let opts = { 
  'body': new OndcProtocolCoreApi.TrackBody() // TrackBody | Buyer tracks fulfillment of an order
};
...
let apiInstance = new OndcProtocolCoreApi.ONDCSellerAppApi();
let opts = { 
  'body': new OndcProtocolCoreApi.UpdateBody() // UpdateBody | Buyer updates an order
};

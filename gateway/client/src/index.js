...
* <pre>
* var OndcProtocolCoreApi = require('index'); // See note below*.
* var xxxSvc = new OndcProtocolCoreApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new OndcProtocolCoreApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new OndcProtocolCoreApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new OndcProtocolCoreApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...

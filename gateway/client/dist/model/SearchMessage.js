 ...
 * @version 1.0.0
 */
var SearchMessage = /*#__PURE__*/function () {
  /**
   ...
   */
  _createClass(SearchMessage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new SearchMessage();
        if (data.hasOwnProperty('intent')) obj.intent = _Intent.Intent.constructFromObject(data['intent']);
      }
      return obj;
    }
  }]);

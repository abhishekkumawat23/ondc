...
exports.OnSearchMessage = void 0;
 ...
 * @version 1.0.0
 */
var OnSearchMessage = /*#__PURE__*/function () {
  /**
   ...
   */
  function OnSearchMessage(catalog) {
    _classCallCheck(this, OnSearchMessage);
   ...
   */
  _createClass(OnSearchMessage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new OnSearchMessage();
        if (data.hasOwnProperty('catalog')) obj.catalog = _Catalog.Catalog.constructFromObject(data['catalog']);
      }
      return obj;
    }
  }]);
 ...
 */
exports.OnSearchMessage = OnSearchMessage;
